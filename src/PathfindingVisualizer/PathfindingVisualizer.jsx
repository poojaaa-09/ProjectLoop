    ...
    if (!this.state.isRunning) {
      ...
      switch (algo) {
        case 'Dijkstra':
          ...
          document.getElementById("result").value = timeTaken;
          break;
        case 'AStar':
    ...
    return (
      <div>
        ...
        <center>
          ...
          <table>
            <tr>
              <th><font color="white"><b><h2>Time Taken:</h2></b></font></th>
              <th> <input type="text" id="result" />
                <font color="white" ><b>  ms</b></font></th>
            </tr>
          </table>
        </center>
